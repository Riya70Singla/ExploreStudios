...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder>{
    private List<String> studioname= Arrays.asList("Delhi Studio","Delhi Studio");
    private List<String> type= Arrays.asList("Video Studio","Video Studio");
    private List<String> price= Arrays.asList("Starting from ₹1000/hr","Starting from ₹1000/hr");
    private List<Integer> image= Arrays.asList(R.drawable.studio,R.drawable.studio);
    @NonNull
    @Override
